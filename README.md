...
- **٥ – ١٤ لاعبًا**، الأدوار: ذيب الديرة 🐺 / الشيخ 🧿 / الحكيم 🌿 / من أهل الديرة 🏠
...
- **دعوة سريعة:** رابط دخول مباشر + زر واتساب + **باركود** يصوّره اللي جنبك ويدخل (وضع المجلس)
- **بطاقات SVG** مرسومة بهوية سدو، **أصوات مولّدة برمجيًا** (بلا ملفات)، وزر **«تخطّي الوقت»** للهوست
...
|---|---|---|
| `assets/img/` | `logo.png, bg-night.png, bg-day.png, avatar-01..12.png` | شعار نصي، تدرجات CSS، إيموجي حيوانات |
| `assets/sfx/` | `wolf-howl.mp3, rooster.mp3, sword.mp3, drum.mp3, save.mp3, card-flip.mp3, win-village.mp3, win-wolves.mp3, night-wind.mp3` (CC0) | **أصوات مولّدة برمجيًا** (WebAudio) — لو وُضع ملف بنفس الاسم تجاوز التركيب |

> البطاقات صارت **SVG مرسومة داخل الكود** ([`js/cards.js`](js/cards.js)) فلا تحتاج `card-*.png` إطلاقًا.
> الباركود يُولَّد محليًا في المتصفح (بلا إرسال بيانات لأي خدمة).
